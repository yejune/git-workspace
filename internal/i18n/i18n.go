...
var messages = map[string]map[string]string{
	"en": {
		...
		"sub_not_found":       "workspace not found: %s",
		...
		"no_gitsubs_found":     "\n→ No .workspaces found. Scanning for existing workspace repositories...",
		"no_subs_found":        "✓ No workspace repositories found",
		"to_add_sub":           "\nTo add a workspace, use:",
		"cmd_git_sub_clone":    "  git workspace clone <url> <path>",
		"created_gitsubs":      "\n✓ Created .workspaces with %d workspace(s)",
		...
		"not_found_cloning":    "→ Workspace not found, cloning...",
		"cloned":               "✓ Cloned",
	...
	"ko": {
		...
		"sub_not_found":       "workspace를 찾을 수 없음: %s",
		...
		"hooks_installed":      "✓ 설치됨",
		"hooks_failed":         "✗ 실패: %v",
		"no_gitsubs_found":     "\n→ .workspaces를 찾을 수 없음. 기존 workspace 저장소 검색 중...",
		"no_subs_found":        "✓ workspace 저장소를 찾지 못했습니다",
		"to_add_sub":           "\nworkspace를 추가하려면:",
		"cmd_git_sub_clone":    "  git workspace clone <url> <path>",
		"created_gitsubs":      "\n✓ %d개 workspace로 .workspaces 생성됨",
		"applying_ignore":      "\n→ ignore 패턴 적용 중",
		...
		"not_found_cloning":    "→ Workspace를 찾을 수 없음, 복제 중...",
		"cloned":               "✓ 복제됨",
